...
if __name__ == "__main__":
    ...
    for times in range(exp_num):
        test_dataset = SeqDataSet(num=2000,seed=random.randint(1,1000))
    ...
    # plt.errorbar(x, y, yerr=y_std, fmt='o', capsize=5,ecolor='black',markeredgecolor='green',  markerfacecolor='green',  )
    plt.errorbar(x, y, yerr=y_std, fmt='o', capsize=5, color='green')
