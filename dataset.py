...
class generator_t:
    ...
    def generate(self, numTrials=int(1e3), seed=123):
        ...
        return data_x, data_y,shapes_end,trialCondi

    def generate1(self,numTrials = 100, seed=123):
...
class SeqDataSet(Dataset):
    def __init__(self, num):
        ...
        x, y, end, trialShape = Train_data.generate(numTrials=num)
